...
#                --trainlist lists/dtu/train.txt --testlist lists/dtu/test.txt --ndepths=96 --CostNum=3 --initloss=initloss --lr=0.0004 --dispmaxfirst=last  --maskupmode=eachstage --interval_scale=0.53  --lossrate=1.0 | tee -i $dirAndName
